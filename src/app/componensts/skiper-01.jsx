...
const Skiper30 = () => {
  ...
  return (
    <div className="">
    <main className=" bg-[#eee] text-black">
...
const Column = ({
  ...
  return (
    <motion.div
      className="relative -top-[45%] flex  w-1/4 h-full md:min-w-[150px] min-w-[250px] flex-col gap-[2vw] first:top-[-45%] [&:nth-child(2)]:top-[-95%] [&:nth-child(3)]:top-[-45%] [&:nth-child(4)]:top-[-75%]"
      style={{ y }}>
      {images.map((src, i) => (
