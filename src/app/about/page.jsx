    ...
    <>
      ...
      <div className="max-w-5xl mx-auto px-4 py-12">
        <div className="text-center mb-10">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">About Revodials</h1>
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          ...
          <div>
            ...
            <p className="text-gray-700 mb-4">
              Revodials was founded with a simple mission: to bring premium quality timepieces
        ...
        <div className="mt-16 text-center">
          <h2 className="text-2xl font-semibold mb-4">Why Choose Revodials?</h2>
          <p className="text-gray-600 max-w-3xl mx-auto">
            From fast shipping and secure checkout to dedicated support and warranty assurance,
            we strive to make your Revodials experience as timeless as our watches.
          </p>
        </div>
        ...
        <div className="mt-10 text-center bg-neutral-100 p-8 rounded-xl shadow">
          ...
          <p className="mt-4 text-lg font-medium">
            <a href="mailto:info.Revodials@gmail.com" className="underline hover:text-gray-400">info.Revodials@gmail.com</a>
          </p>
        </div>
      </div>
    </>
